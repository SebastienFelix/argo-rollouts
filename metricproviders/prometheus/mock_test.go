...
func (m *mockAPI) Series(ctx context.Context, matches []string, startTime time.Time, endTime time.Time, opt ...v1.Option) ([]model.LabelSet, v1.Warnings, error) {
	panic("Not used")
}
...
func (m *mockAPI) TSDB(ctx context.Context, opt ...v1.Option) (v1.TSDBResult, error) {
	panic("Not used")
}
